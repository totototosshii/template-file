      ...
      <div class="section-inner">
        <div class="section-content">
          <div class="section-contents">
            ...
            <figure class="contents-img"><img src="<?php echo esc_url(get_theme_file_uri( 'images/story-img1.jpg' )); ?>" alt=""></figure>
          </div><!-- /.section-contents -->
        </div><!-- /.section-content -->
      </div><!-- /.section-inner -->
    </section><!-- /.section -->
      ...
      <div class="section-inner">
        <div class="section-content">
          <div class="section-contents">
            ...
            <figure class="contents-img"><img src="<?php echo esc_url(get_theme_file_uri( 'images/story-img2.jpg' )); ?>" alt=""></figure>
          </div><!-- /.section-contents -->
        </div><!-- /.section-content -->
      </div><!-- /.section-inner -->
    </section><!-- /.section -->
      ...
      <div class="section-inner">
        <div class="section-content">
          <div class="section-contents">
            ...
            <figure class="contents-img"><img src="<?php echo esc_url(get_theme_file_uri( 'images/story-img3.jpg' )); ?>" alt=""></figure>
          </div><!-- /.section-contents -->
        </div><!-- /.section-content -->
      </div><!-- /.section-inner -->
    </section><!-- /.section -->
