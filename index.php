        ...
        <div class="section-content">
          ...
          <div class="synopsis">
            <p class="synopsis-text">
              「平和」について改めて考えるストーリー全世界を司るものが神だ<br>とすれば、なぜ神であるクリシュナは、策を巡らしてまで、登場人<br>物すべてを滅亡へと導いたのか？<br>それは、「戦い」そのものを廃絶しようとしたからだと考えられ<br>る。戦うことそのものへの虚しさ、「戦い」そのものの「悪」を問う<br>物語が「マハーバーラタ」と言える。<br>平和とは？私たちには何ができるのか？根源的な「平和」を希求す<br>る物語。
            </p><!-- /.synopsis-text -->
            <p class="synopsis-text">
              現代社会を映し出す人間ドラマ対難民問題やヘイトスピーチ問題に<br>見られるように、文化的背景が「異」な<br>るものに対して非寛容になりつつある現代社会。<br>神の血を引きながらも、現代人同様に欲望や嫉妬によって争う登場<br>人物たちが破滅していく様を描いた「マハーバーラタ」のストーリ<br>ーは、人類が歩んできた争いの歴史の物語とも言い換えられる<br>非寛容による悲劇の物語である「マハーバーラタ」を現代社会に重<br>ね合わせつつ描くことで「寛容」の重要性を示す。
            </p><!-- /.synopsis-text -->
          </div><!-- /.synopsis -->
        </div><!-- /.section-content -->
      </div><!-- /.section-inner -->
    ...
    <section class="section" data-fadeIn>
      <div class="section-inner">
        <div class="section-content">
          ...
          <a href="<?php echo home_url( '/news-archive' ); ?>" class="btn news-btn">ニュース一覧へ</a><!-- /.btn -->
        </div><!-- /.section-content -->
      </div><!-- /.section-inner -->
    </section><!-- /.section -->
    ...
    <section class="section" data-fadeIn>
      <div class="section-inner">
        <div class="section-content">
          ...
          <a href="<?php home_url( '/cast' ); ?>" class="cast-more-btn">もっと見る</a><!-- /.cast-more-btn -->
        </div><!-- /.section-content -->
      </div><!-- /.section-inner -->
    </section><!-- /.section -->
